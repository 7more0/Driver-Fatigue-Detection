...
with open('./out/train_clip_feature_sample.pkl', 'wb') as file:
    pickle.dump(clip_feature_sample, file)
    print('train data:', len(clip_feature_sample))
    file.close()


# val data path config
read_path = './Datasets/YawDD/lstm/val/video'
frame_path = './Datasets/YawDD/lstm/val/val_frames'
...
with open('./out/val_clip_feature_sample.pkl', 'wb') as file:
    pickle.dump(clip_feature_sample, file)
    print('val data:', len(clip_feature_sample))
    file.close()
